...
Such an investigation was performed, taking measurements at increasing distances, in the range $[2,44$-$5]$, of the signal strength from an AP in line-of-sight. In Figure \ref{noise_corr_los} the resulting noise is displayed. The \emph{correlation coefficient $\hat  r_{xy}$} between the two can be estimated using,
\begin{equation}
