...
The advantages of using WiFi Access Points (APs) are several. The technique is well established and APs exists in almost every indoors environment, making no further investment in hardware required. Further, there are there are potential for techniques to locate APs with 

2.4 and 5 GHz

Sensor and wifi equipped smartphones
