...
%
When implementing the particle filter, it is of interest to discern between different states or poses the user is in, like walking or being still. One of the reasons for this is that the state update of the particle filter can be changed according to the pose, i.e. when still no benefit is drawn from updating the heading, step length or movement 
%
