...
\caption{Paths and environments used during the different tests in this thesis. The floor depicted is the top floor in the Glasgow building at SOMC, Lund.}
\label{env_map}
\end{minipage}
\end{figure}
