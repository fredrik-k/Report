...
\begin{figure}[!hbt]
\include{graphics}
\includegraphics[width=1\textwidth ]{images/backround_on_navigation/axis_device.png}
\caption{device axis.}\label{axis_device}
\end{figure}
...
This algorithm uses some heuristic assumptions concerning the power from different floors when estimating the current one. One of them is that if the signals from three consecutive floors are approximately equal the most probable location is on the middle floor. 
