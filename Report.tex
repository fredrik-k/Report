...
%
\section{Goal}
Investiaget 2.4 and 5 GHz

Develop a positioning algorithm using wifi only

Improve this algorithm by including sensor data 
...
Approximately known C and $\alpha$ - depends on AP, building and smartphone. 

2.4 and 5 GHz enabled smartphone

Accelerometer and gyroscope

Fixed phone for optimal performance
%
\section{Platform}
