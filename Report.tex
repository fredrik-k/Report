...
\begin{tabular}{|l|c|}
\hline
\multicolumn{1}{|c|}{Parameter} & Magnitude \\
\hline
\hline
$C$ for 2.4 GHz & -38 dB \\
\hline
...
\begin{tabular}{|l|c|}
\hline
\multicolumn{1}{|c|}{Parameter} & Distribution \\
\hline
\hline
...
\caption{Figure text}\label{path_multi}
\end{figure}
%
...
\caption{Figure text}\label{error_multi}
\end{figure}
%
...
\hline
Positioning algorithm & Maximum error & Average error & Median error \\
\hline
\hline
Particle filter - WiFi & 11.6 & 3.5 & 3.1  \\
\hline
Pedestrian dead reckoning & 7.7 & 4.2 & 4.8  \\
\hline
Particle filter - WiFi \& sensors & 5.8 & 1.8 & 1.8 \\
\hline
\end{tabular}
\end{center}
\caption{Error of the different positioning algorithms}\label{table:error_different_algorithms}
\end{table}
...
\caption{Figure text}\label{step_length}
\end{figure}
%
...
\caption{Figure text}\label{path_no_step_est}
\end{figure}
%
...
\caption{Figure text}\label{error_no_step_est}
\end{figure}
%
