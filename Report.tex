...
In the implementation a user has been deemed as still if no steps has been detected over the course of three seconds and subsequently deemed moving if not still. This is a fairly crude method of distinguishing between poses, but in the current use case, it displays sufficient performance.  
%
