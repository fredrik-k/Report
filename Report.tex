...
\caption{Position estimations of different algorithms in \emph{Environment three}.}\label{path_multi}
\end{figure}
%
...
\caption{Error of the position estimation unsing both WiFi and the sensors. The step length was set to 0.83 m.}\label{error_no_step_est}
\end{figure}
%
