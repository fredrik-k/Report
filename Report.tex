...
\item[Case 1:] \hfill \\
%
Measurements of the RSSI is taken at equally spaced points with $0.5$ meters spacing over a predetermined path. Only measurements from predetermined APs with known positions are taken. The measurements are taken while the measuring phone is at rest at each point.  
%
\item[Case 2:] \hfill \\
%
